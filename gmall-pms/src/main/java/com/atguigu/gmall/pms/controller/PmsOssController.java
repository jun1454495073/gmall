...
public class PmsOssController {
    ...
    //返回值是Resp<Object>,返回policy以及签名给浏览器
    String accessId = "LTAI4FuCkRweX58zVnWA4CPM"; // 请填写您的AccessKeyId。
    String accessKey = "sG0GKT538NPgf9WWgqQ97Bah8CfqSp"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "zjlgmall"; // 请填写您的 bucketname 。
