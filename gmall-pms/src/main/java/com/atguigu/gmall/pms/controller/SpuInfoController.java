...
public class SpuInfoController {
    ...
    @GetMapping
    public Resp<PageVo> querySpuByCatId(QueryCondition condition,@RequestParam(value = "catId",defaultValue = "0")Long catId){
        PageVo pageVo = spuInfoService.querySpuByCatId(condition,catId);
